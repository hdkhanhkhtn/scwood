...
customer/save" name="frm" id="frm"  method="post" enctype="multipart/form-data" autocomplete="off">
...
unset($_smarty_tpl_vars);
 ?></td>
        ...
        <tr>
            <td valign="top" align="center" ><?php if ($this->_tpl_vars['mr']['frm_error']): ?><span style="color:#F00;font-family:Tahoma, Geneva, sans-serif;"><?php echo $this->_tpl_vars['mr']['frm_error']; ?>
</span><?php endif; ?><?php if ($this->_tpl_vars['mr']['password']): ?><span style="color:#F00;font-family:Tahoma, Geneva, sans-serif;"><?php echo $this->_tpl_vars['mr']['password']; ?>
</span><?php endif; ?>
                                    ...
                                    <table cellpadding="0" cellspacing="0" class="t0">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="tr0 td2"><input tabindex="1" id="datepicker" type="text" name="sc_date" value="<?php echo $this->_tpl_vars['mr']['sc_date']; ?>
" style="width:100px;font: bold 15px;margin-left: 5px;"/></td>
...
" />
                                                    <input tabindex="2" id="sc_file_code" type="text" name="sc_file_code" value="<?php echo $this->_tpl_vars['mr']['sc_file_code']; ?>
" style="width:100px;font: bold 15px;margin-left: 5px;" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <p class="p8 ft1" style="font: bold 15px;">LOCATION AND DESCRIPTION OF PROPERTY INSPECTED:
                                        <input tabindex="3" type="text" name="sc_location" value="<?php echo $this->_tpl_vars['mr']['sc_location']; ?>
" style="width: 360px; margin-left: 10px;font: bold 15px;" />
                                    </p>
                                    <table cellpadding="0" cellspacing="0" class="t1">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="tr3 td9"><p class="p10 ft13 space1 ft3">YES
                                                        <input tabindex="4" type="radio" name="sc_area" value="1" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_area'] == 1): ?>checked<?php endif; ?> />
                                                    </p></td>
                                                <td class="tr3 td10"><p class="p11 ft13 space1 ft3">NO
                                                        <input tabindex="5" type="radio" name="sc_area" value="0" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_area'] == 0): ?>checked<?php endif; ?>/>
                                                    </p></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="tr4 td9"><p class="p13 ft13"> <span class="space1">
                                                            <input tabindex="6" type="radio" name="sc_infest1a_act" value="1" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1a_act'] == 1): ?>checked<?php endif; ?>/>
                                                        </span> 
                                                        <span class="space">
                                                            <input tabindex="7" type="radio" name="sc_infest1a_act" value="0" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1a_act'] == 0): ?>checked<?php endif; ?>/>
                                                        </span></p></td>
                                                <td class="tr4 td10"><p class="p14 ft13"><span class="space1">
                                                            <input tabindex="8" type="radio" name="sc_infest1a_pre" value="1" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1a_pre'] == 1): ?>checked<?php endif; ?>/>
                                                        </span> <span class="space">
                                                            <input tabindex="9" type="radio" name="sc_infest1a_pre" value="0" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1a_pre'] == 0): ?>checked<?php endif; ?>/>
                                                        </span></p></td>
                                            </tr>
                                            <tr>
                                                <td class="tr4 td8"><p class="p16 ft15">b.Drywood termites</p></td>
                                                <td class="tr4 td9"><p class="p13 ft13"> <span class="space1">
                                                            <input tabindex="10" type="radio" name="sc_infest1b_act" value="1" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1b_act'] == 1): ?>checked<?php endif; ?>/>
                                                        </span> <span class="space">
                                                            <input tabindex="11" type="radio" name="sc_infest1b_act" value="0" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1b_act'] == 0): ?>checked<?php endif; ?>/>
                                                        </span></p></td>
                                                <td class="tr4 td10"><p class="p14 ft13"><span class="space1">
                                                            <input tabindex="12" type="radio" name="sc_infest1b_pre" value="1" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1b_pre'] == 1): ?>checked<?php endif; ?>/>
                                                        </span> <span class="space">
                                                            <input tabindex="13" type="radio" name="sc_infest1b_pre" value="0" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1b_pre'] == 0): ?>checked<?php endif; ?>/>
                                                        </span></p></td>
                                            </tr>
                                            <tr>
                                                <td class="tr4 td8"><p class="p16 ft15">c.Old house borers</p></td>
                                                <td class="tr4 td9"><p class="p13 ft13"> <span class="space1">
                                                            <input tabindex="14" type="radio" name="sc_infest1c_act" value="1" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1c_act'] == 1): ?>checked<?php endif; ?>/>
                                                        </span> <span class="space">
                                                            <input tabindex="15" type="radio" name="sc_infest1c_act" value="0" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1c_act'] == 0): ?>checked<?php endif; ?>/>
                                                        </span></p></td>
                                                <td class="tr4 td10"><p class="p14 ft13"><span class="space1">
                                                            <input tabindex="16" type="radio" name="sc_infest1c_pre" value="1" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1c_pre'] == 1): ?>checked<?php endif; ?>/>
                                                        </span> <span class="space">
                                                            <input tabindex="17" type="radio" name="sc_infest1c_pre" value="0" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1c_pre'] == 0): ?>checked<?php endif; ?>/>
                                                        </span></p></td>
                                            </tr>
                                            <tr>
                                                <td class="tr4 td8"><p class="p16 ft15">d.Powder post beetles</p></td>
                                                <td class="tr4 td9"><p class="p13 ft13"> <span class="space1">
                                                            <input tabindex="18" type="radio" name="sc_infest1d_act" value="1" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1d_act'] == 1): ?>checked<?php endif; ?>/>
                                                        </span> <span class="space">
                                                            <input tabindex="19" type="radio" name="sc_infest1d_act" value="0" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1d_act'] == 0): ?>checked<?php endif; ?>/>
                                                        </span></p></td>
                                                <td class="tr4 td10"><p class="p14 ft13"><span class="space1">
                                                            <input tabindex="20" type="radio" name="sc_infest1d_pre" value="1" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1d_pre'] == 1): ?>checked<?php endif; ?>/>
                                                        </span> <span class="space">
                                                            <input tabindex="21" type="radio" name="sc_infest1d_pre" value="0" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1d_pre'] == 0): ?>checked<?php endif; ?>/>
                                                        </span></p></td>
                                            </tr>
                                            <tr>
                                                <td class="tr4 td8"><p class="p17 ft18">e.Other <nobr>wood-destroying</nobr> insects</p></td>
                                        <td class="tr4 td9"><p class="p13 ft13"> <span class="space1">
                                                    <input tabindex="22" type="radio" name="sc_infest1e_act" value="1" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1e_act'] == 1): ?>checked<?php endif; ?>/>
                                                </span> <span class="space">
                                                    <input tabindex="23" type="radio" name="sc_infest1e_act" value="0" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1e_act'] == 0): ?>checked<?php endif; ?>/>
                                                </span></p></td>
                                        <td class="tr4 td10"><p class="p14 ft13"><span class="space1">
                                                    <input tabindex="24" type="radio" name="sc_infest1e_pre" value="1" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1e_pre'] == 1): ?>checked<?php endif; ?>/>
                                                </span> <span class="space">
                                                    <input tabindex="25" type="radio" name="sc_infest1e_pre" value="0" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest1e_pre'] == 0): ?>checked<?php endif; ?>/>
                                                </span></p></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="tr4 td9"><p class="p13 ft13"> <span class="space1 ft3">YES</span>
                                              <input tabindex="26" type="radio" name="sc_infest2" value="1" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest2'] == 1): ?>checked<?php endif; ?>/>
                                            </p></td>
                                            <td class="tr4 td10"><p class="p14 ft13 ft3"> <span class="space1">&nbsp;NO</span>
                                                    <input tabindex="27" type="radio" name="sc_infest2" value="0" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest2'] == 0): ?>checked<?php endif; ?>/>
                                                </p></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <td class="tr4 td9"><p class="p13 ft13"> <span class="space1 ft3">YES</span>
                                                <input tabindex="28" type="radio" name="sc_infest3a" value="1" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest3a'] == 1): ?>checked<?php endif; ?>/>
                                            </p></td>
                                        <td class="tr4 td10"><p class="p14 ft13"> <span class="space1 ft3">&nbsp;NO</span>
                                                <input tabindex="29" type="radio" name="sc_infest3a" value="0" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest3a'] == 0): ?>checked<?php endif; ?>/>
                                            </p></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <td class="tr4 td9"><p class="p13 ft13 ft3"> <span class="space1">YES</span>
                                                <input tabindex="30" type="radio" name="sc_infest3b" value="1" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest3b'] == 1): ?>checked<?php endif; ?>/>
                                            </p></td>
                                        <td class="tr4 td10"><p class="p14 ft13 ft3"><span class="space1">&nbsp;NO</span>
                                                <input tabindex="31" type="radio" name="sc_infest3b" value="0" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest3b'] == 0): ?>checked<?php endif; ?>/>
                                            </p></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tr4 td9"><p class="p13 ft13 ft3"> <span class="space1">YES</span>
                                                    <input tabindex="32" type="radio" name="sc_infest4" value="1" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest4'] == 1): ?>checked<?php endif; ?>/>
                                                </p></td>
                                            <td class="tr4 td10"><p class="p14 ft13 ft3"> <span class="space1">&nbsp;NO</span>
                                                    <input tabindex="33" type="radio" name="sc_infest4" value="0" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_infest4'] == 0): ?>checked<?php endif; ?>/>
                                                </p></td>
                                        </tr>
                                        <tr>
                                      ...
                                      <input tabindex="34" name="infest4percent[from]" style="width:50px;font: bold 15px;" type="text" value="<?php echo $this->_tpl_vars['mr']['infest4percent_from']; ?>
" />
                                        % to
                                        <input tabindex="35" name="infest4percent[to]" type="text" value="<?php echo $this->_tpl_vars['mr']['infest4percent_to']; ?>
" style="width:50px;font: bold 15px;" />
                                        %</p>
                                    <p class="p24 ft22"><span class="ft21 ft3">Damage: </span>Termite, other <nobr>wood-destroying</nobr> insects and fungi (Note: reporting of fungi damage to wood, commonly called water damage, decay or rot, is limited to the area below the first main floor of the structure as defined in <nobr>27-1085</nobr> K(3)(f) SCRR.)</p>
                                          ...
                                          <td class="tr4 td9"><p class="p13 ft13 ft3"> <span class="space1">YES</span>
                                                        <input tabindex="36" type="radio" name="sc_damage" value="1" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_damage'] == 1): ?>checked<?php endif; ?>//>
                                                    </p></td>
                                          <td class="tr4 td10"><p class="p14 ft13 ft3"> <span class="space1">&nbsp;NO</span>
                                                        <input tabindex="37" type="radio" name="sc_damage" value="0" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_damage'] == 0): ?>checked<?php endif; ?>//>
                                                    </p></td>
                                        </tr>
                                          <tr>
                                ...
                                <tbody>
                                          ...
                                          <tr>
                                              ...
                                              <td class="tr6 td25"><p class="p0 ft2">
                                                      <input tabindex="38" name="sc_treat1_desc" style="width: 300px;margin-left: 12px;" type="text" value="<?php echo $this->_tpl_vars['mr']['sc_treat1_desc']; ?>
"/>
                                                  </p></td>
                                              <td class="tr5 td20"><p class="p0 ft2">&nbsp;</p></td>
                                              <td class="tr6 td26"><p class="p0 ft2">
                                                      <input tabindex="39" id="sc_treat1_date" name="sc_treat1_date" style="width: 100px;" type="text" value="<?php echo $this->_tpl_vars['mr']['sc_treat1_date']; ?>
" />
                                                  </p></td>
                                              <td class="tr5 td22"><p style="text-align: right;padding-right: 60px;" class="p0 ft2">
                                                      <input tabindex="40" type="checkbox" name="sc_treat1" value="1" style="text-align:right;" <?php if ($this->_tpl_vars['mr']['sc_treat1'] == 1): ?>checked<?php endif; ?>/>
                                                  </p></td>
                                          </tr>
                                          <tr>
                                      ...
                                      <tr>
                                          ...
                                          <td class="tr5 td22"><p style="text-align: right;padding-right: 60px;" class="p0 ft2">
                                                  <input tabindex="41" type="checkbox" name="sc_treat2" value="1" style="text-align:right;"<?php if ($this->_tpl_vars['mr']['sc_treat2'] == 1): ?>checked<?php endif; ?>/>
                                              </p></td>
                                      </tr>
                                      <tr>
                                          ...
                                          <td class="tr5 td22"><p style="text-align: right;padding-right: 60px;" class="p0 ft2">
                                                  <input tabindex="42" type="checkbox" name="sc_treat3" value="1" style="text-align:right;" <?php if ($this->_tpl_vars['mr']['sc_treat3'] == 1): ?>checked<?php endif; ?>/>
                                              </p></td>
                                      </tr>
                                      <tr>
                                          ...
                                          <td class="tr5 td22"><p style="text-align: right;padding-right: 60px;" class="p0 ft2">
                                                  <input tabindex="43" type="checkbox" name="sc_treat4" value="1" style="text-align:right;" <?php if ($this->_tpl_vars['mr']['sc_treat4'] == 1): ?>checked<?php endif; ?>/>
                                              </p></td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        ...
                                        <tr>
                                          <td colspan="5" class="tr5 td23"><p class="p42 p0 ft6 ft13">Additional pages are attached. <span class="ft1">YES</span><input tabindex="44" type="radio" name="sc_remark" value="1" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_remark'] == 1): ?>checked<?php endif; ?>>
                                          <span class="ft3">NO</span><input tabindex="45" type="radio" name="sc_remark" value="0" style="-webkit-appearance: checkbox; -moz-appearance: checkbox; -ms-appearance: checkbox; -o-appearance: checkbox;" <?php if ($this->_tpl_vars['mr']['sc_remark'] == 0): ?>checked<?php endif; ?>></p></td>
                                        </tr>
                                        <tr>
                                          <td colspan="5" class="tr5 td23"><span class="tr4 td31">
                                  <textarea tabindex="46" style="display: block;margin: 15px 0 0 20px;width: 775px;" name="sc_remark_desc" cols="90" rows="15"><?php echo $this->_tpl_vars['mr']['sc_remark_desc']; ?>
</textarea>
                                  </span></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td colspan="7" class="tr6 td35"><p class="p0 ft23">
                                                            <input tabindex="47" name="sc_firm" type="text" value="<?php echo $this->_tpl_vars['mr']['sc_firm']; ?>
" style="width:225px;font: bold 15px;">
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="4" class="tr11 td37"><p class="p0 ft2"><input tabindex="48" type="text" value="<?php echo $this->_tpl_vars['mr']['sc_license_num']; ?>
" name="sc_license_num" style="width:290px;font: bold 15px;"></p></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3" class="tr6 td47"><p class="p0 ft2"><input tabindex="50" type="text" value="<?php echo $this->_tpl_vars['mr']['sc_bus_li_num']; ?>
" name="sc_bus_li_num" style="width:100px;font: bold 15px;"></p></td>
                                                    <td colspan="3" class="tr5 td34"><p class="p44 ft6" style="font: bold 15px;">ADDRESS:&nbsp;</p></td>
                                                    <td colspan="7" class="tr6 td35"><p class="p0 ft23">
                                                            <input tabindex="51" name="sc_add1" type="text" value="<?php echo $this->_tpl_vars['mr']['sc_add1']; ?>
" style="width:225px;font: bold 15px;" />
                                                        </p></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="4" class="tr12 td33"><p class="p0 ft6">ACKNOWLEDGMENT:</p></td>
                                                    <td colspan="10" class="tr12 td50"> <p class="p0 ft23"><input tabindex="52" name="sc_add2" type="text" value="<?php echo $this->_tpl_vars['mr']['sc_add2']; ?>
" style="width:225px;margin-left: 220px;"></p>                  </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td colspan="4" class="tr11 td53"><p class="p0 ft2"><input tabindex="53" id="sc_date_ack" name="sc_date_ack" type="text" value="<?php echo $this->_tpl_vars['mr']['sc_date_ack']; ?>
" style="width:230px"></p></td>
                                                ...
                                                <?php if ($this->_tpl_vars['mr']['image']): ?>
                                                    <tr>
                                                        <td colspan="14" class="tr13 td33"><p><img src="<?php echo $this->_tpl_vars['site']['base_url']; ?>
uploads/report/<?php echo $this->_tpl_vars['mr']['image']; ?>
" width="150" height="100"  alt="" /> <input tabindex="55" name="chk_delfile" type="checkbox" id="chk_delfile" value="1" > Delete file.</p></td>
                                                    </tr>
                                                <?php endif; ?>
                                                <tr>
                                                    <td colspan="14" class="tr13 td33">
                                                        <p style="margin-top: 20px;">
                                                            ...
                                                            <input tabindex="57" name="hd_old_image" type="hidden" id="hd_old_image" value="<?php echo $this->_tpl_vars['mr']['image']; ?>
" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
"><?php echo $this->_tpl_vars['inspector'][$this->_sections['i']['index']]['name']; ?>
</option>
                                                            ...
                                                            <?php if ($this->_tpl_vars['mr']['id']): ?><br />
                                                                E-mail 1 : &nbsp;&nbsp; <input tabindex="62" type="text" id="txt_email1" name="txt_email1"  style="border: 1px solid #FF771D;"/> <span style="color:#F00;font-size:12px;"><?php echo $this->_tpl_vars['mr']['email1']; ?>
</span><?php if ($this->_tpl_vars['mr']['invoice_id']): ?><input tabindex="63" name="txt_attached1" type="checkbox" value="<?php echo $this->_tpl_vars['mr']['invoice_id']; ?>
" /> Attached invoice<?php endif; ?><br /> <br />

                                                                E-mail 2 : &nbsp;&nbsp; <input tabindex="64" type="text" id="txt_email2" name="txt_email2" style="border: 1px solid #FF771D;" /> <span style="color:#F00;font-size:12px;"><?php echo $this->_tpl_vars['mr']['email2']; ?>
</span><?php if ($this->_tpl_vars['mr']['invoice_id']): ?><input tabindex="65" name="txt_attached2" type="checkbox" value="<?php echo $this->_tpl_vars['mr']['invoice_id']; ?>
" /> Attached invoice<?php endif; ?><br /><br />

                                                                E-mail 3 : &nbsp;&nbsp; <input tabindex="66" type="text" id="txt_email3" name="txt_email3"  style="border: 1px solid #FF771D;"/> <span style="color:#F00;font-size:12px;"><?php echo $this->_tpl_vars['mr']['email3']; ?>
</span><?php if ($this->_tpl_vars['mr']['invoice_id']): ?><input tabindex="67" name="txt_attached3" type="checkbox" value="<?php echo $this->_tpl_vars['mr']['invoice_id']; ?>
" /> Attached invoice<?php endif; ?><br /><br />

                                                                E-mail 4 : &nbsp;&nbsp; <input tabindex="68" type="text" id="txt_email4" name="txt_email4"  style="border: 1px solid #FF771D;"/> <span style="color:#F00;font-size:12px;"><?php echo $this->_tpl_vars['mr']['email4']; ?>
</span><?php if ($this->_tpl_vars['mr']['invoice_id']): ?><input tabindex="69" name="txt_attached4" type="checkbox" value="<?php echo $this->_tpl_vars['mr']['invoice_id']; ?>
" /> Attached invoice<?php endif; ?><br /><br />

                                                                E-mail 5 : &nbsp;&nbsp; <input tabindex="70" type="text" id="txt_email5" name="txt_email5"  style="border: 1px solid #FF771D;"/> <span style="color:#F00;font-size:12px;"><?php echo $this->_tpl_vars['mr']['email5']; ?>
</span><?php if ($this->_tpl_vars['mr']['invoice_id']): ?><input tabindex="71" name="txt_attached5" type="checkbox" value="<?php echo $this->_tpl_vars['mr']['invoice_id']; ?>
" /> Attached invoice<?php endif; ?>
                                                            <?php endif; ?></div>
                                                    </td>
                                                </tr>
                                            </tbody>
...
text-align: center;">
                            <?php if ($this->_tpl_vars['mr']['id']): ?><a  onclick="javascript:OpenSubWin('<?php echo '{$site.base_url}'; ?>
print_history/print_report/id/<?php echo '{$mr.id}'; ?>
','550','500','1');"  title="Click here to show report history">
                            <input class="btn" value="Update History" type="button" /></a>&nbsp;&nbsp;&nbsp;<a onclick="javascript:OpenSubWin('<?php echo '{$site.base_url}'; ?>
print_history/print_mail/id/<?php echo '{$mr.id}'; ?>
','550','500','1');" title="Click here to show email history"><input class="btn" value="Email History" type="button" /></a>&nbsp;&nbsp;&nbsp;
                            <input class="btn" value="Send Email" type="button" onclick="sm_frm(frm,'<?php echo '{$site.base_url}'; ?>
customer/send_email','_self',2)" />
                            &nbsp;&nbsp;&nbsp;<input class="btn" value="Print" type="button" onclick="sm_frm(frm,'<?php echo '{$site.base_url}'; ?>
customer/r_print/id/<?php echo '{$mr.id}'; ?>
','_blank',1)" />                                 &nbsp;&nbsp;&nbsp;
                            ...
                            <?php endif; ?>
                            <input tabindex="74" type="hidden" name="txt_new" id="txt_new"  value="<?php echo '{$mr.new}'; ?>
"/>
                        </td>
                    </tr>
                </table></td>
...
<style >
div ul li:hover div ul li </style>
<!--[if lte ie 6]> 
div  </style>
<![endif]-->
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'customer/frm_report_js.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>