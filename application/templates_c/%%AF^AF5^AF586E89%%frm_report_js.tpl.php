...
<?php echo 'themes/jquery/jquery-ui-timepicker-addon.js"></script>
<script type="text/javascript" src="'; ?>
<?php echo $this->_tpl_vars['site']['base_url']; ?>
<?php echo 'themes/jquery/jquery-ui-sliderAccess.js"></script>
<script type="text/javascript" src="'; ?>
<?php echo $this->_tpl_vars['site']['base_url']; ?>
<?php echo 'themes/jquery/jquery.cookie.js"></script>
    ...
    $(function(){
        ...
        $("#frm").validate({
			...
			submitHandler: function(form){
				sm_frm(form,"'; ?>
<?php echo $this->_tpl_vars['site']['base_url']; ?>
<?php echo 'customer/save",\'_self\',3);
			}
        });
