<?php /* Smarty version 2.6.18, created on 2012-10-21 21:29:33
         compiled from print_r/index_r.tpl */ ?>
...
<table cellspacing="1" align="center" width="500" id="myTable" class="dataTable" >
	<thead>
    	<tr>
    	  <td align="right"><input type="button" class="button_2" value="Print" onclick="javascript:OpenSubWin('<?php echo $this->_tpl_vars['site']['base_url']; ?>
print_history/rprint/id/<?php echo $this->_tpl_vars['mr']['id']; ?>
','550','500','1');" />
...
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['report_history']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
            <tr>
                ...
                <td><?php echo $this->_tpl_vars['report_history'][$this->_sections['i']['index']]['date']; ?>
</td>
            </tr>
		<?php endfor; endif; ?>
        </tbody>
