...
<page_header>
    ...
    <td align="center" style=" width:50%; font-size:20; <?php echo $bg_center ?>"  >REPORT HISTORY<br><?php echo 'VA/HUD/FHA CASE '.$this->mr['r1a'] ?>
	</td>
...
<thead>
  <tr align="center" >
    <td style="width:100%;<?php  echo $style_header ?>">Date time</td>
    </tr>
</thead>
  <?php for($i=0; $i<count($this->mlist); $i++){ ?>
  <tr >
    <td height="15" align="center" style="width:100%;<?php echo $bdashed ?>"><?php echo $this->mlist[$i]['date']?></td>
  </tr>
  <?php } ?>
