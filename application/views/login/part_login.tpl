...
<table width="250" border="0" cellpadding="0" cellspacing="5">
	{if $mr.error_frm}
	  <tr >
		<td  colspan="3" align="center" ><span style="color:#F00;">{$mr.error_frm}</span></td>
	  </tr>
  {/if}
  <tr>
  ...
  <tr>
  	<td colspan="3" align="center">
    	<a href="{$site.base_url}login/forgetpass" style="color:#FF771D;font-family:Tahoma, Geneva, sans-serif;font-size:13px;font-weight:normal;" >Forgot password ?</a>
    </td>
  </tr>
  <tr>
  	<td colspan="3" align="center">
    	<a href="{$site.base_url}register" style="color:#FF771D;font-family:Tahoma, Geneva, sans-serif;font-size:13px;font-weight:normal;" >Create a new account ?</a>
    </td>
  </tr>
</table>
</form>