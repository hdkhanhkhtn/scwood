<?php
class polldt_model extends Model {
	
	var $tbl_name = "poll_detail";
	var $tbl_id ="polldt_id";
	
    function polldt_model()
    {
        parent::Model();
    }
	
	function get_by_poll($id)
	{
		 $this->db->select('*');
		 
		 $this->db->from($this->tbl_name);
		 
		 $this->db->where('polldt_poll_id',$id);
		 
		// Get all
		$this->db->order_by($this->tbl_id, "asc"); 
