<?php
class policydt_model extends Model {
	
	var $tbl_name = "policy_detail";
	var $tbl_id ="policydt_id";
	
    function policydt_model()
    {
        parent::Model();
    }
	...
	function get($id = '',$data = '')
	{
		 ...
		 if(!$id){
			// Get all
			$this->db->order_by("policydt_order", "desc"); 
			$this->db->order_by("policydt_id", "asc"); 
